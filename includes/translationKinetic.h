...
#ifndef __TRANSLATION_KINETIC_H_
#define __TRANSLATION_KINETIC_H_

/*
	Define the different types of translations:
		DEFAULT: 		A default translation generated by some function outside of the
						translation class
		SPLIT_PART_1: 	The first part of a split translation
		SPLIT_PART_2: 	The second part of a split translation
*/
...
class TranslationKinetic : public Translation{
...
private:
	...
	*/
	...
	/*
		...
		capable of generating translations of type DEFAULT. Pick the moving vertex and its
	...
	*/
	TranslationKinetic(Triangulation *Tr, Vertex *v, double dX, double dY, TranslationType tp);
